...
const Hero = ({
  ...
  return (
    <section className="relative h-screen bg-gradient-to-b from-gray-50 to-white reveal-on-scroll overflow-hidden">
      {/* Background pattern */}
      ...
      <div className="container mx-auto px-4 relative z-10 flex flex-col md:flex-row items-center justify-center h-full">
      ...
      {showAnchorHint && (
        <div
          className="fixed left-1/2 bottom-8 transform -translate-x-1/2 cursor-pointer flex flex-col items-center animate-fade-in"
